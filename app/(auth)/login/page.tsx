...
import { logInuserObjectType } from '@/app/types/types'
...
const Page = () => {
  ...
  return (
    ...
    <form onSubmit={handleSubmit}>
      <input type="text" value={user.collegeEmail} name='collegeEmail' placeholder='Enter email' onChange={handleChange} />
